...
# Install & Setup — Oceanology NextGen
...
![UE Project Browser — Third Person template](/img/oceanology-nextgen/setup/ue55-new-project-third-person.png)

## 3) Enable the plugin in your project

1. In UE, open **Edit → Plugins**.
2. Search `Oceanology NextGen` and enable it.
3. Click **Restart Now** when prompted.

![Open Plugins window](/img/oceanology-nextgen/setup/menu-edit-plugins.png)
![Enable plugin](/img/oceanology-nextgen/setup/plugins-search-oceanology.png)
![Restart to apply](/img/oceanology-nextgen/setup/plugins-enabled-restart-now.png)

## 4) View sample content

1. Open **Content Browser**. Click the gear icon.
2. Enable **Show Engine Content** and **Show Plugin Content**.
3. Navigate to **Engine/Plugins/OCEANOLOGY NEXTGEN Content** and open a sample map.

![Show Engine and Plugin Content](/img/oceanology-nextgen/setup/content-browser-settings-show-engine-plugin.png)
![Plugin content folder](/img/oceanology-nextgen/setup/content-browser-oceanology-content-folder.png)
