...
<div className="doc-badge doc-badge-violet">🌊 Visual Effects</div>
<div className="doc-badge doc-badge-cyan">🎨 Post-Processing</div>
<div className="doc-badge doc-badge-emerald">💡 God Rays</div>
...
| **Lighting** | A Directional Light (required for God Rays) |

:::info Underwater Modes
Oceanology Legacy offers two underwater rendering modes: **Underwater** (post-process based) and **Volumetric Fog** (volumetric rendering). Each has different visual characteristics and performance implications.
:::
