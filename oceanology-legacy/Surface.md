...
- Basic familiarity with **Materials**, **shaders**, and **post-processing** in Unreal Engine.

## Notes
- Surface rendering in Oceanology Legacy controls the visual appearance of your water bodies. This includes scattering, absorption, caustics, refraction, and normal calculations that together create realistic or stylized water surfaces.
- Surface settings are configured directly on the **BP_OceanologyInfiniteOcean** or **BP_OceanologyLake** actors. Each water body can have its own unique surface appearance.
- The workflow in this page focuses on understanding each surface category and how they interact to produce the final visual result.
