...
The **Spline Data Generator** provides a complete workflow for authoring breaking wave animations using 21 spline curves that represent the full lifecycle of a surf wave—from initial swell through barrel formation to collapse and wash.
